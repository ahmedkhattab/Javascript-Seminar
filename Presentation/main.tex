...
\begin{frame}{Proxy Pattern - The analogy}
 \begin{figure}[htp]
    \centering
    \includegraphics[width=7cm]{secretary}
    \label{fig:proxy}
    \end{figure}
\end{frame}
...
\begin{frame}{Proxy Pattern - In Detail}
    \begin{figure}[htp]
    \centering
    \includegraphics[width=7cm]{proxy2}
    \label{fig:proxy2}
    \end{figure}
\end{frame}
...
\begin{frame}{Decorator Pattern - The analogy}
    \begin{figure}[htp]
    \centering
    \includegraphics[width=6cm]{coffee}
    \label{fig:decorator}
    \end{figure}
\end{frame}
...
\begin{frame}{Decorator Pattern - In Detail}
    \begin{figure}[htp]
    \centering
    \includegraphics[width=8cm]{decorator2}
...
\begin{frame}{Fa\c{c}ade Pattern - The analogy}
    \begin{figure}[htp]
    \centering
    \includegraphics[width=7cm]{facade2}
    \label{fig:facade}
    \end{figure}
\end{frame}
...
\begin{frame}{Fa\c{c}ade Pattern - In Detail}
    \begin{figure}[htp]
    \centering
    \includegraphics[width=7cm]{facade}
    \label{fig:facade2}
    \end{figure}
\end{frame}
...
A simple application for fetching location-specific weather information from a web service
    \begin{figure}[htp]
    \centering
    \includegraphics[width=7cm]{weatherapp}
    \label{fig:weather}
    \end{figure}
...
The famous Pacman implemented in JavaScript and HTML5 canvas
    \begin{figure}[htp]
    \centering
    \includegraphics[width=5cm]{pacman}
    \label{fig:pacman}
    \end{figure}
...
\end{itemize}
    ...
    \begin{figure}[htp]
    \centering
    \includegraphics[width=7cm]{ghosts}
    \label{fig:ghosts}
    \end{figure}
\end{frame}
...
A huge Ghost.draw() function:
 \begin{itemize}
   ...
   \begin{figure}[htp]
    \centering
    \includegraphics[width=8cm]{Legs}
    \label{fig:legs}
    \end{figure}
\end{frame}
